...
public class LivrosGUI implements ActionListener{
    ...
    //Creating Text Fields
     ...
     LivrosGUI(List<ObjBibliotecario> lista){
        vetor = lista;
     }
   ...
   public void actionPerformed(ActionEvent e) {
      if(e.getActionCommand().equals("Incluir")){
         try{
            vetor.add(new Livro(tituloTf.getText(), Integer.parseInt(anoTf.getText()), autorTf.getText()));
         }
         catch(Exception exc){
      ...
      if(e.getActionCommand().equals("Revistas")){
         RevistasGUI revista = new RevistasGUI(vetor);
         revista.startGUI();
      }
   }
}
