...
public class RevistasGUI implements ActionListener{
      private List <ObjBibliotecario> vetor;
     //Creating JFrame
    ...
    //Creating Text Fields
     ...
     RevistasGUI(List <ObjBibliotecario> vetorIn){
         vetor = vetorIn;
     }
     ...
     public void actionPerformed(ActionEvent e) {
      if(e.getActionCommand().equals("Incluir")){
         try{
            vetor.add(new Revista(tituloTf.getText(), Integer.parseInt(anoTf.getText()), orgTf.getText(), Integer.parseInt(volTf.getText()), Integer.parseInt(nroTf.getText())));
         }
         catch(Exception exc){
      ...
      if(e.getActionCommand().equals("Listagem")){
         ...
         lista.printObj(vetor);
      }

      if(e.getActionCommand().equals("Livros")){
         LivrosGUI livro = new LivrosGUI(vetor);
         livro.startGUI();
      }
   }
}
